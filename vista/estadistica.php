...
<div class="container mt-3" style="margin-left: 300px;">
  ...
  <div id="carrusel" class="d-flex align-items-stretch position-relative" style="overflow:hidden; width:85%; height: 80%; margin-top: 2%;">
    ...
    <div id="carrusel-inner" class="d-flex" style="transition: transform 0.5s;">
      ...
      <div class="card m-2" style="width: 630px;">
        ...
        <div class="h-100  p-4 rounded shadow-sm">
          ...
          <div>
            <h2 class="fw-bold mt-3">
              Número total de patologias crónicas registradas: 
    ...
    <button id="nextBtn" class="btn btn-secondary carrusel-btn carrusel-btn-right"><img class="w-6 h-8 imagen" src="img/angulo-derecho.png" alt=""></button> 
  </div>

  <div id="carrusel-indicadores" class="text-center mt-3" style="overflow:hidden; width:80%; ">
