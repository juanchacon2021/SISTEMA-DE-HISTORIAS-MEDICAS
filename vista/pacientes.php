        ...
        <form method="post" id="f" autocomplete="off" style="margin: 0em 2em 2em 2em;">
          ...
          <div class="container step" id="step-1">
            <div class="row mb-6">
                ...
                <div>
                    <div class="col-md-1 mb-4 p-1 rounded-full" style="background-color: rgb(220 38 38);"></div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6 mt-4">
                    ...
                    <select class="form-control bg-gray-200 rounded-lg border-white p-3 text" id="estadocivil" name="estadocivil">
          ...
          <div class="container step d-none" id="step-2">
            <div class="row mb-3">
                ...
                <div class="col-md-6 mb-2 mt-4">
                    ...
                    <input class="form-control bg-gray-200 rounded-lg border-white p-3" placeholder="Alergias" type="text" id="alergias" name="alergias"/>
                    <span id="salergias"></span>
                </div>
                <div class="col-md-6 mt-4">
                    <label for="alergias_med" class="texto-inicio font-medium mb-2">Alergias Médicas *</label>
                    <input class="form-control bg-gray-200 rounded-lg border-white p-3" placeholder="Alergias Medicas" type="text" id="alergias_med" name="alergias_med"/>
                    <span id="salergias_med"></span>
                </div>
                <div class="col-md-6 mt-4">
                    <label for="habtoxico" class="texto-inicio font-medium mb-2">Habito Toxico *</label>
                    <input class="form-control bg-gray-200 rounded-lg border-white p-3" placeholder="Habito Toxico" type="text" id="habtoxico" name="habtoxico"/>
            ...
            <div class="row mb-6">
                <div class="col-md-4 mt-4">
                    ...
                    <input class="form-control bg-gray-200 rounded-lg border-white p-3" placeholder="Quirurgico" type="text" id="quirurgico" name="quirurgico"/>
                    <span id="squirurgico"></span>
                </div>
                <div class="col-md-4 mt-4">
                    <label for="transsanguineo" class="texto-inicio font-medium mb-2">Trans Sanguineos *</label>
                    <input class="form-control bg-gray-200 rounded-lg border-white p-3" placeholder="Trans Sanguineos" type="text" id="transsanguineo" name="transsanguineo"/>
                    <span id="stranssanguineo"></span>
                </div>
                <div class="col-md-4 mt-4">
                    <label for="hda" class="texto-inicio font-medium mb-2">HDA *</label>
                    <input class="form-control bg-gray-200 rounded-lg border-white p-3" placeholder="HDA" type="text" id="hda" name="hda"/>
                    <span id="shda"></span>
                </div>
            </div>
          </div>
