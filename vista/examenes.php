...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="container espacio">
            <section class="content">
                ...
                <div class="container-fluid d-flex">
                    <!-- Tabs -->
                    <ul class="nav nav-tabs" id="examenesTabs" role="tablist">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-success" onclick="mostrarModalRegistroExamen()">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="filtroPaciente" placeholder="Cédula o nombre">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="filtroFechaExamen">Filtrar por Fecha:</label>
                                        <input type="date" class="form-control" id="filtroFechaExamen">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="filtroTipoExamen">Filtrar por Tipo:</label>
                                        <select class="form-control" id="filtroTipoExamen">
                                            <option value="">Todos los tipos</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover" id="tablaRegistrosExamen" style="width:100%">
                    ...
                    <div class="tab-pane fade" id="tipos" role="tabpanel">
                        <div class="cardd mt-3">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title">Listado de Tipos de Examen</h3>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-success" onclick="mostrarModalTipoExamen('incluir')">
                                            Nuevo Tipo
                                        </button>
                                        <a href="vista/fpdf/tipos_examen.php" target="_blank" class="btn btn-primary">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover" id="tablaTiposExamen" style="width:100%">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th>Código</th>
                                                <th>Nombre</th>
        ...
        <div class="modal fade" id="modalRegistroExamen" tabindex="-1" role="dialog" aria-labelledby="modalRegistroExamenLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="modalRegistroExamenLabel">Registrar Examen</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="pacienteExamen" name="cedula_paciente" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="tipoExamen" name="cod_examen" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fechaExamen" name="fecha_e" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="horaExamen">Hora</label>
                                        <input type="time" class="form-control" id="horaExamen" name="hora_e" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="observacionExamen">Observaciones</label>
                                <textarea class="form-control" id="observacionExamen" name="observacion_examen" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="archivoExamen">Resultado del Examen (Imagen)</label>
                                <input type="file" class="form-control" id="archivoExamen" name="imagenarchivo" accept=".png,.jpg,.jpeg">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info" id="btnGuardarRegistroExamen">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modalTipoExamen" tabindex="-1" role="dialog" aria-labelledby="modalTipoExamenLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="modalTipoExamenLabel">Registrar Tipo de Examen</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="formTipoExamen" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="descripcion_examen" name="descripcion_examen" rows="3"></textarea>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary" id="btnGuardarTipoExamen">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
