...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(110, 15, utf8_decode('CDI Carmen Estella Mendoza de Flores'), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
...
$pdf->Output('Historia.pdf', 'D');//nombreDescarga, Visor(I->visualizar - D->descargar)
