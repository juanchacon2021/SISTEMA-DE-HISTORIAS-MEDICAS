		   ...
		   <form method="post" id="f" autocomplete="off">
			...
			<div class="row mb-12 " >
				...
				<div class="col-md-3" >
					...
					<div class="row-md-3" style=" display: flex; width: 25rem;">
						...
						<button style="width: 25rem;" type="button" class="btn btn-primary" id="listadodepersonal" name="listadodepersonal">LISTADO DE PERSONAL</button>
				...
				<div class="col-md-3" style="margin-left: 9rem;" >
					...
					<div class="row-md-3" style=" display: flex; width: 25rem;">
						...
						<button style="width: 25rem;" type="button" class="btn btn-primary" id="listadodepacientes" name="listadodepacientes">LISTADO DE PACIENTES</button>
...
<!-- sssssssssssssssssssssss -->
				...
				<div class="ml-8 mb-8">
                    <div class="texto-inicio font-medium">Examenes de sitema</div>
                </div>
			...
			<div class="row mb-3">
						...
						<div class="col-md-3">
							<label for="extremidades_s" class="texto-inicio font-medium">Extremidades s</label>
			...
			<div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <label for="extremidades_r" class="texto-inicio font-medium">Extremidades R</label>
			...
			<div class="texto-inicio font-medium">Examen fisico</div>
			</div>
