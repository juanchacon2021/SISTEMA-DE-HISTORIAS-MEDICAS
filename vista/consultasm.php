	...
	<div class="container espacio">
		...
		<div class="container">
			<div class="row mt-3 botones">
				...
				<div class="col-md-2">
					<button type="button" id="btnobservacion" class="btn botonverde" data-bs-toggle="modal" data-bs-target="#modalobservacion">
						Observaciones
					</button>
				</div>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row mt-3 justify-content-center mb-4">
							<div style="color: white;" id= "regobserv" class="col-md-2 botonverde" style="cursor: pointer;" onclick='pone(this,4)'>
