				...
				<form method="post" id="f" autocomplete="off">
					...
					<div class="container">	
						...
						<div class="row mb-3">
							...
							<div class="col-md-12">
								<label class="texto-inicio font-medium" for="procedimiento">procedimiento</label>
								<textarea rows="2" cols="25" class="form-control bg-gray-200 rounded-lg border-white" type="text" id="procedimiento"></textarea>
								<span id="sprocedimiento"></span>
							</div>
						</div>
