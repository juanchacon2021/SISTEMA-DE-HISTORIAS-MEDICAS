...
const TEST_CASE_EXTERNAL_ID = 'SGM-12'; // cambia al ID real en tu TestLink
...
async function runTest() {
    ...
    try {
        ...
        const cedulaPacienteAEliminar = '10000001';

        // XPath para localizar el enlace <a> por su atributo 'cedula_paciente'
        // y que también tenga la clase 'btn-danger' (para asegurarnos de que es el de eliminar)
        const xpathBotonEliminarPaciente = `//a[@cedula_paciente='${cedulaPacienteAEliminar}' and contains(@class, 'btn-danger')]`;

        await driver.findElement(By.xpath(xpathBotonEliminarPaciente)).click();
        ...
        // === Paso 8: precionar el boton de envio ===
        ...
        // === Paso 9: Validar el modal de éxito ===
