...
const TEST_CASE_EXTERNAL_ID = 'SGM-6'; // cambia al ID real en tu TestLink
...
async function runTest() {
    ...
    try {
        ...
        // 1. Esperar a que el elemento sea visible usando el selector CSS a.eliminar
        await driver.wait(until.elementIsVisible(driver.findElement(By.css('a.eliminar'))), 10000);

        // 2. Hacer clic directamente
        await driver.findElement(By.css('a.eliminar')).click();
